...
const mealFormMenus = document.getElementById('menus')
const mealFormSnacks = document.getElementById('snacks')

const mealFormDate = document.getElementById('mealDate')
const mealFormName = document.getElementById('mealName')
